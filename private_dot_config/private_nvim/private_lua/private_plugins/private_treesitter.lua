return {
  ...
  config = function()
    ...
    local languages = {
      "c", "c3", "bash", "css", "dockerfile", "go", "html", "javascript", "json", "lua",
      "markdown", "php", "python", "scss", "sql", "typescript", "vim", "vue", "yaml",
    }
    ...
    vim.treesitter.query.set(
      ...
      [[
        ...
        ;; Match literal keyword nodes if defined in grammar
        [
          "defer"
          "raw"
          "orelse"
        ...
        ;; Fallback: Match as keywords if parsed as generic identifiers
        ((identifier) @keyword (#any-of? @keyword "defer" "raw" "orelse"))
      ]]
    )
  end,
}
